...
export const PAGE_HELP: Record<PageName, string> = {
  ...
  Research: "Esc returns to navigation. Tab/Shift+Tab move between pages. F6 toggles focus inside the page. Ctrl+1..Ctrl+9 jump pages. Ctrl+B and Ctrl+F switch between the history and prompt. Enter runs Codex web research and writes a note into Obsidian. Ctrl+O opens the latest research note in Obsidian. While waiting, a loading card shows elapsed time. PageUp/PageDown or mouse wheel scroll the report.",
...
export const PAGE_INTRO: Record<PageName, string> = {
  ...
  Research: "Research mode uses Codex web search. The TUI shows the summary; the full report and sources are written to Obsidian.",
