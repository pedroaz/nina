        ...
        <section className="flex min-h-[60vh] items-center justify-center px-4 py-10">
            ...
            >
                ...
                <div className="flex flex-col gap-3">
                    ...
                    >
                        <div className="flex items-center space-x-2 rounded-lg border border-slate-200 p-4 hover:bg-slate-50">
                            <RadioGroupItem value="multiple_choice" id="multiple_choice" />
                            <Label htmlFor="multiple_choice" className="flex-1 cursor-pointer">
                                <div className="font-medium">Multiple Choice</div>
                                <div className="text-xs text-slate-600">Answer questions by choosing from 4 options</div>
                            </Label>
                        </div>
                        <div className="flex items-center space-x-2 rounded-lg border border-slate-200 p-4 hover:bg-slate-50">
                            ...
                            <Label htmlFor="sentence_creation" className="flex-1 cursor-pointer">
                                ...
                                <div className="text-xs text-slate-600">Write sentences based on prompts, judged by AI</div>
                            </Label>
                        </div>
                    </RadioGroup>
                </div>
